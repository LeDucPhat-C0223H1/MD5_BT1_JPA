...
public class CategoryController {
    ...
    public String doAddNewCategory(@ModelAttribute CategoryRequest categoryRequest, Model model){
...
//    // Cập nhật
    ...
    public String doUpdateCategory(@ModelAttribute Category categoryEdit, Model model){
